 ...
 */
function geocities_root_relative_url($input) {
...
if (geocities_enable_root_relative_urls()) {
  ...
  add_filters($root_rel_filters, 'geocities_root_relative_url');
}
